/**
 * MySwiper - Version personnalisée basée sur react-native-swiper
 * Vous pouvez adapter ce code selon vos besoins.
 */
...
export default class MySwiper extends Component {
  ...
  initState(props, updateIndex = false) {
    ...
    initState.width = props.width || (this.state && this.state.width) || width;
    initState.height = props.height || (this.state && this.state.height) || height;
  ...
  // Combine l'état avec les variables internes
  fullState() {
  ...
  scrollBy = (index, animated = true) => {
    ...
    if (!animated || Platform.OS !== 'ios') {
      setImmediate(() => {
        this.onScrollEnd({ nativeEvent: { position: diff } });
      });
    }
  };
